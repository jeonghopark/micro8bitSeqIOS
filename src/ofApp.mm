...
//    }
    ...
    int _speed = (float)ofMap(downPart.length/12, 0, 1024/12, 2, 30);
    ...
    //            }
    //
    //            if (_index==((i*speedFactor8th)+delayupPart%8)){
